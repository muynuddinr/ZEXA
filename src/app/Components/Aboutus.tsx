      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 border border-[#08b48d]/30">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">To empower businesses with digital solutions that drive growth</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-[#08b48d] rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-white">Vision</h4>
                    <p className="text-gray-300 text-sm">To be the leading digital agency for innovative businesses</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <div
              key={index}
              className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-[#08b48d]/50 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl hover:shadow-[#08b48d]/20 group"
            >
              <div className="mb-4 group-hover:scale-110 transition-transform duration-300">
                {value.icon}
              </div>
              <h4 className="text-xl font-semibold text-white mb-3 group-hover:text-[#08b48d] transition-colors duration-300">
                {value.title}
              </h4>
              <p className="text-gray-300 leading-relaxed">
                {value.description}
        ...
        <div className="text-center mt-16 pt-12 border-t border-white/10">
          ...
          <button className="inline-flex items-center justify-center px-8 py-3 bg-linear-to-r from-[#08b48d] to-[#00d4aa] text-black font-semibold rounded-lg hover:shadow-2xl hover:shadow-[#08b48d]/50 transform hover:scale-105 transition-all duration-300">
            Start Your Project
          </button>
        </div>
      </div>
